...
if __name__ == '__main__':
    ...
    # Count the number of gpu_available
    gpu_count = torch.cuda.device_count()
    print("The number of gpu_available is: ", gpu_count)

    # Check the current gpu
    gpu_current = torch.cuda.current_device()
    print("The current gpu is: ", gpu_count)

    # distributed computing ?
    gpu_distributed = torch.distributed.is_initialized()
    print("The current computing type is: ", gpu_distributed)
